...
const WELCOME_KEY = 'wb.welcomeSeen';
...
export function mountWelcome() {
  ...
  host.innerHTML = `
    <div class="welcome-overlay">
      <div class="welcome-card">
        <h1 class="welcome-title" id="welcomeTitle">欢迎使用个人工作台</h1>
      </div>
    </div>`;
  ...
  if (window.scrambleText) window.scrambleText(host.querySelector('#welcomeTitle'), '欢迎使用个人工作台', { duration: 1.1 });
